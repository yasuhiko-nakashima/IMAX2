...
#define MAXNUMBER 1
  ...
  /**************************/
  {
    ...
    /* | * * * * * * * * |                                                                        */
    /* +-----------------+                                                                        */
    soft_bar2[DATAOUT0].ful = (int)(a);          hard_bar2w(DATAOUT0,  soft_bar2[DATAOUT0].ful);
    soft_bar2[DATAOUT1].ful = (int)(a>>32);      hard_bar2w(DATAOUT1,  soft_bar2[DATAOUT1].ful);
    soft_bar2[DATAOUT2].ful = (int)(b);          hard_bar2w(DATAOUT2,  soft_bar2[DATAOUT2].ful);
    soft_bar2[DATAOUT3].ful = (int)(b>>32);      hard_bar2w(DATAOUT3,  soft_bar2[DATAOUT3].ful);
    soft_bar2[DATAOUT4].ful = (int)(0x89abcdef); hard_bar2w(DATAOUT4,  soft_bar2[DATAOUT4].ful);
    soft_bar2[DATAMSK0].ful = 0xffffffff;        hard_bar2w(DATAMSK0,  soft_bar2[DATAMSK0].ful); /* 0:hiZ 1:connect */
    soft_bar2[DATAMSK1].ful = 0xffffffff;        hard_bar2w(DATAMSK1,  soft_bar2[DATAMSK1].ful); /* 0:hiZ 1:connect */
    soft_bar2[DATAMSK2].ful = 0xffffffff;        hard_bar2w(DATAMSK2,  soft_bar2[DATAMSK2].ful); /* 0:hiZ 1:connect */
    soft_bar2[DATAMSK3].ful = 0xffffffff;        hard_bar2w(DATAMSK3,  soft_bar2[DATAMSK3].ful); /* 0:hiZ 1:connect */
    soft_bar2[DATAMSK4].ful = 0xf0f0f0f0;        hard_bar2w(DATAMSK4,  soft_bar2[DATAMSK4].ful); /* 0:hiZ 1:connect */
    hard_bar2sync();

    /** FILM½ñ¤­¹þ¤ß **/
    soft_bar2[WRCOUNT].ful  = 0x00008000;        hard_bar2w(WRCOUNT,   soft_bar2[WRCOUNT].ful);
    hard_bar2sync();

    /** ÆÉ¤ß½Ð¤· **/
    while ((soft_bar2[WRCOUNT].ful = hard_bar2r(WRCOUNT)) != 0) { /* ¡úSOFT¢«HARD¡ú */
    ...
    printf("A=%08.8x_%08.8x B=%08.8x_%08.8x\n", (int)(a>>32), (int)a, (int)(b>>32), (int)b);
    printf("dout[4:0]=%08.8x_%08.8x_%08.8x_%08.8x_%08.8x\n", soft_bar2[DATAOUT4].ful, soft_bar2[DATAOUT3].ful, soft_bar2[DATAOUT2].ful, soft_bar2[DATAOUT1].ful, soft_bar2[DATAOUT0].ful);
    printf("dmsk[4:0]=%08.8x_%08.8x_%08.8x_%08.8x_%08.8x\n", soft_bar2[DATAMSK4].ful, soft_bar2[DATAMSK3].ful, soft_bar2[DATAMSK2].ful, soft_bar2[DATAMSK1].ful, soft_bar2[DATAMSK0].ful);
    printf("dtin[4:0]=%08.8x_%08.8x_%08.8x_%08.8x_%08.8x\n", hard_bar2r(DATAIN4), hard_bar2r(DATAIN3), hard_bar2r(DATAIN2), hard_bar2r(DATAIN1), hard_bar2r(DATAIN0));
  }
#endif
  return (0);
}
