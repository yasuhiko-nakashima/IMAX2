     ...
     char **argv;
{
  ...
  for (argc--, argv++; argc; argc--, argv++) {
    ...
    default:
      printf("%s\n", version());
      printf("usage: osim -f image.ppm\n");
      printf("       osim -c (from camera)\n");
      exit(1);
    }
  }
...
#define MAXNUMBER 1
  ...
  /*********************/
  {
	...
	//for (y=0; y<OUTY; y++) {
        //  for (x=0; x<OUTX; x++) {
	/* ¼ÂºÝ¤Ë¤Ï,K-meansÅù¤Ë¤è¤ëºÇÅ¬ÇÛÃÖÃµº÷¤¬É¬Í×¤Î¤Ï¤º */
	...
	for (step=0; step<STEPS; step++) {
	  ...
	  for (y=0; y<NWIDTH; y++) {
	    ...
	    HCURR[y][x] = (oNEURON[y][x+1] - oNEURON[y][x])/HLINK[y][x];
            ...
            //HLINK[y][x] = (HCSUM[y][x] < THRESHOLD ? HCSUM[y][x]/(THRESHOLD/(MAGNI+1)) : MAGNI) + HLINKinit; /* ÎßÀÑÅÅÎ®ÎÌ¤Ë¤è¤êÄñ¹³¤¬Áý²Ã¤¹¤ë¥â¥Ç¥ë */
            //if ((x==4)&&(y==4)){
            //  printf("HCSUM = %f\n",HCSUM[y][x]);
            //}
	    }
	  ...
	  for (y=0; y<NWIDTH-1; y++) {
	    for (x=0; x<NWIDTH; x++) {
	      VCURR[y][x] = (oNEURON[y+1][x] - oNEURON[y][x])/VLINK[y][x];
              ...
              //printf("%d\n",VCURR[y][x]);
              //VLINK[y][x] = (VCSUM[y][x] < THRESHOLD ? VCSUM[y][x]/(THRESHOLD/(MAGNI+1)) : MAGNI) + VLINKinit; /* ÎßÀÑÅÅÎ®ÎÌ¤Ë¤è¤êÄñ¹³¤¬Áý²Ã¤¹¤ë¥â¥Ç¥ë */
	    }
	  }
	  /* update NEURON */
	  for (y=0; y<NWIDTH; y++) {
	    for (x=0; x<NWIDTH; x++) {
	      ...
	      //            printf("%d  %d  %d  %d   \n",N,S,W,E);
	      nNEURON[y][x] = (OTON*(oNEURON[y][x]-MAGNI/2) + (N + S + W + E) + MAGNI/2) ; /* ¼þ°Ï¤ÎÅÅ²Ù°ÜÆ°¤Ë¤è¤êÅÅ°µ¤¬ÊÑÆ°¤¹¤ë¥â¥Ç¥ë */
  ...
  {
    /* +-----------------+ ¡ÚNNET¤Î¾ì¹ç¤ÎÎã¡Û                                                     */
    /* | * * * * * * * * |  aH,aL ¤Î¹ç·×64bit¤Ç 8x8¤Î2ÃÍ²èÁü¤òÍ¿¤¨¤ë                              */
    /* | * * * * * * * * |  bH,bL ¤Î¹ç·×64bit¤Ç 8x8¤Î²¿¤«¡¤¤Þ¤¿¤Ï¥Ñ¥é¥á¥¿¤òÍ¿¤¨¤ë                 */
    /* | * * * * * * * * |  ASIC¤«¤éNNCHIP¤Ø¤Ï¡¤1ÂÐ1¤ËÀÜÂ³¤¹¤ë¤¿¤á¤Î64¤Ê¤¤¤·128ËÜ¤ÎÇÛÀþ           */
    /* | * * * * * * * * |                                                                        */
    /* | * * * * * * * * |  ½ÐÎÏ¤Ï32bit¤Î¤¦¤Á16bit»ÈÍÑ Îã¤¨¤Ð0-9A-F¤ËÂÐ¤·¡¤³Æ1bit»ÈÍÑ²ÄÇ½         */
    /* | * * * * * * * * |  NNCHIP¤«¤éASIC¤Ø¤Ï¡¤1ÂÐ1¤ËÀÜÂ³¤¹¤ë¤¿¤á¤Î32ËÜ¤ÎÇÛÀþ                    */
    /* | * * * * * * * * |                                                                        */
    /* | * * * * * * * * |                                                                        */
    /* +-----------------+                                                                        */

    /*               #1      #2      #3      #720                                             */
    /*       0n      10n     20n ... 7190n   7200n                                            */
    /* SCK   /~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___                         */
    /*       0n                              7205n                                            */
    /* SCKIH ____________________________________/~~~~~~~~~~~~~~~~~~~~~~~~~~~                 */
    ...
    /* D1    _______________/~~~~~~~~~~~~~~~~~~~~~~~~~~~                                      */
    /*                                       7200n                                            */
    /* SOUT  ________________________________/~~~~~~~~~~~~~~~~~~~~~~~~~~~                     */

    /*               7220n   7230n   7240n   7250n   7260n   7270n                            */
    /* DCK   ________/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___/~~~\___ */
    /*       7210n                                                           7300n            */
    /* MODE  ________________________________________________________________/~~~~~~~~~~~~~~~ */
    /*           7215n   7225n   7235n   7245n   7255n   7265n   7275n                        */
    /* IH0   ~~~~\_______/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    /* IH1   ~~~~~~~~~~~~\_______/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    /* IH2   ~~~~~~~~~~~~~~~~~~~~\_______/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    /* IH3   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~\_______/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    ...
    /* IH5   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\_______/~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    /*                                                                               7400n    */
    /* EVA   ________________________________________________________________________/~~~~~~~ */

    while (1) {
      soft_bar2[EVA32_01].ful  = 0x00000000; hard_bar2w(EVA32_01,  soft_bar2[EVA32_01].ful);
      soft_bar2[MODE].ful      = 0x00000000; hard_bar2w(MODE,      soft_bar2[MODE].ful);
      soft_bar2[SIN].ful       = 0x00000001; hard_bar2w(SIN,       soft_bar2[SIN].ful);
      soft_bar2[SCK].ful       = 0x00000000; hard_bar2w(SCK,       soft_bar2[SCK].ful);
      soft_bar2[SCK].ful       = 0x00000001; hard_bar2w(SCK,       soft_bar2[SCK].ful);
      soft_bar2[IH5_0].ful     = 0x456789ab; hard_bar2w(IH5_0,     soft_bar2[IH5_0].ful);
      soft_bar2[SPIKE23_0].ful = 0x456789ab; hard_bar2w(SPIKE23_0, soft_bar2[SPIKE23_0].ful);
      soft_bar2[DCK].ful       = 0x00000000; hard_bar2w(DCK,       soft_bar2[DCK].ful);
      soft_bar2[DCK].ful       = 0x00000001; hard_bar2w(DCK,       soft_bar2[DCK].ful);
      soft_bar2[OSEL1_0].ful   = 0x00000000; hard_bar2w(OSEL1_0,   soft_bar2[OSEL1_0].ful);
      soft_bar2[MODE].ful      = 0x00000001; hard_bar2w(MODE,      soft_bar2[MODE].ful);
      soft_bar2[CAPTURE].ful   = 0x003fffff; hard_bar2w(CAPTURE,   soft_bar2[CAPTURE].ful);
      soft_bar2[EVA32_01].ful  = 0x00000003; hard_bar2w(EVA32_01,  soft_bar2[EVA32_01].ful);
      hard_bar2sync();
    }

    /** ÆÉ¤ß½Ð¤· **/
    while ((soft_bar2[CAPTURE].ful = hard_bar2r(CAPTURE)) != 0) { /* ¡úSOFT¢«HARD¡ú */
      printf("soft_bar2[CAPTURE]=%08.8x din[2:0]=%08.8x_%08.8x_%08.8x\n",
	     soft_bar2[CAPTURE].ful, hard_bar2r(XDIFF14_0), hard_bar2r(XPLUS14_0), hard_bar2r(SOUT));
    }
    printf("dout[2:0]=%08.8x_%08.8x_%08.8x\n", hard_bar2r(XDIFF14_0), hard_bar2r(XPLUS14_0), hard_bar2r(SOUT));
    printf("dtin[2:0]=%08.8x_%08.8x_%08.8x\n", hard_bar2r(XDIFF14_0), hard_bar2r(XPLUS14_0), hard_bar2r(SOUT));
  }
#endif
  return (0);
}
