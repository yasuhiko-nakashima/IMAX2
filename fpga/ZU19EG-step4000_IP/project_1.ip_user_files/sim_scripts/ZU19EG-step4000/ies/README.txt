...
#
# Generated by export_simulation on Thu Mar 30 09:05:34 JST 2023
#
################################################################################
...
'-reset_run' switch to the './fpga_bram64.sh' script.

./fpga_bram64.sh -reset_run
...
./fpga_bram64.sh -noclean_files

For more information on the script, please type './fpga_bram64.sh -help'.
