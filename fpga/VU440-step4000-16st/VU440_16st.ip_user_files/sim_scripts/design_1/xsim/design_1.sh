...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L gtwizard_ultrascale_v1_7_5 -L fifo_generator_v13_2_3 -L xlconstant_v1_1_5 -L gigantic_mux -L xlconcat_v2_1_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
