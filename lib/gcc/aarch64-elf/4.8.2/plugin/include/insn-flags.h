...
#define HAVE_aarch64_cmhsv8qi (TARGET_SIMD)
#define HAVE_aarch64_cmhiv8qi (TARGET_SIMD)
#define HAVE_aarch64_cmtstv8qi (TARGET_SIMD)
#define HAVE_aarch64_cmhsv16qi (TARGET_SIMD)
#define HAVE_aarch64_cmhiv16qi (TARGET_SIMD)
#define HAVE_aarch64_cmtstv16qi (TARGET_SIMD)
#define HAVE_aarch64_cmhsv4hi (TARGET_SIMD)
#define HAVE_aarch64_cmhiv4hi (TARGET_SIMD)
#define HAVE_aarch64_cmtstv4hi (TARGET_SIMD)
#define HAVE_aarch64_cmhsv8hi (TARGET_SIMD)
#define HAVE_aarch64_cmhiv8hi (TARGET_SIMD)
#define HAVE_aarch64_cmtstv8hi (TARGET_SIMD)
#define HAVE_aarch64_cmhsv2si (TARGET_SIMD)
#define HAVE_aarch64_cmhiv2si (TARGET_SIMD)
#define HAVE_aarch64_cmtstv2si (TARGET_SIMD)
#define HAVE_aarch64_cmhsv4si (TARGET_SIMD)
#define HAVE_aarch64_cmhiv4si (TARGET_SIMD)
#define HAVE_aarch64_cmtstv4si (TARGET_SIMD)
#define HAVE_aarch64_cmhsv2di (TARGET_SIMD)
#define HAVE_aarch64_cmhiv2di (TARGET_SIMD)
#define HAVE_aarch64_cmtstv2di (TARGET_SIMD)
#define HAVE_aarch64_cmhsdi (TARGET_SIMD)
#define HAVE_aarch64_cmhidi (TARGET_SIMD)
...
extern rtx        gen_aarch64_cmhsv8qi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv8qi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv8qi                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv16qi                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv16qi                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv16qi                 (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv4hi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv4hi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv4hi                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv8hi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv8hi                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv8hi                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv2si                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv2si                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv2si                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv4si                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv4si                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv4si                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsv2di                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhiv2di                   (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmtstv2di                  (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhsdi                     (rtx, rtx, rtx);
extern rtx        gen_aarch64_cmhidi                     (rtx, rtx, rtx);
